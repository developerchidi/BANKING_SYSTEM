      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          <View style={styles.placeholderCard}>
            <Ionicons name="receipt-outline" size={64} color="#10b981" />
            <Text style={styles.placeholderTitle}>Chi tiết giao dịch</Text>
            <Text style={styles.placeholderSubtitle}>ID: {transactionId || 'N/A'}</Text>
