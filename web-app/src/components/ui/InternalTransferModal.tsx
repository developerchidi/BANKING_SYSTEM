...
const InternalTransferModal: React.FC<Props> = ({ open, onClose }) => {
    ...
    <div className="fixed inset-0 bg-white/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">Internal Transfer</h2>
          {!hideClose && (
        ...
        <div className="p-6">
          <TransferFormContainer transferType="internal" onClose={onClose} />
        </div>
      </div>
    </div>
  );
